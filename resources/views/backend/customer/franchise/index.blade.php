...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3">{{translate('All franchise')}}</h1>
    </div>
</div>
...
<div class="card">
    <form class="" id="sort_customers" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-0 h6">{{translate('Franchise')}}</h5>
            </div>
            {{--<div class="col-md-2 mb-2 mb-md-0">
                <a href="{{ route('user.export') }}" style="color:#fff;" class="btn border" type="button">
                    {{translate('Export User')}}
                </a>
            </div>
            <div class="col-md-2 dropdown mb-2 mb-md-0">
                <button class="btn border btn-warning dropdown-toggle" type="button" data-toggle="dropdown">
                    {{translate('Filter')}}
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="{{ url('admin/customers?filter=ascending') }}">{{translate('Ascending')}}</a>
                    <a class="dropdown-item" href="{{ url('admin/customers?filter=descending') }}">{{translate('Descending')}}</a>
                </div>
            </div>
            <div class="col-md-2 dropdown mb-2 mb-md-0">
                        ...
                        @if ($user != null)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    @endif
										<a href="{{route('franchise_pin_code.view', $user->id)}}" class="mt-2 btn btn-soft-danger btn-circle btn-sm" title="{{ translate('Saved Address') }}">
											Add Pin Code
										</a>
                                    {{--
										<a href="{{route('customers.address', $user->id)}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm" title="{{ translate('Saved Address') }}">
