            ...
            <form class="p-4" action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Master Product') }}</label>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Master Service') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Product Orders') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Service Order') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Bulk Order') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Enquiry') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
