...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Add New Master Service')}}</h5>
</div>
<div class="add-new-style">
    <form class="form form-horizontal mar-top" action="{{route('masterservices.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                        ...
                        <div class="form-group row mb-3">
							...
							<div class="col-sm-9">
								<select name="relatedproducts[]" id="products" class="form-control aiz-selectpicker" multiple data-placeholder="{{ translate('Choose Products') }}" data-live-search="true" data-selected-text-format="count">
									@foreach($master_services as $product)
