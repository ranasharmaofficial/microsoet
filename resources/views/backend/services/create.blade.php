                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_id" onchange="get_types(this.value);" data-live-search="true" required>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="about"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
				...
				<div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="our_services"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="service_image" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="document" data-multiple="true">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="broucher" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
				...
				<div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-3">
							...
							<div class="col-sm-9">
								<select name="boughtproducts[]" data-max-options="2" id="bought_prod" class="form-control aiz-selectpicker" multiple data-placeholder="{{ translate('Choose Services') }}" data-live-search="true" data-selected-text-format="count">
					...
					<div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="Key" name="service_key[]" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Values" name="service_value[]" value="">
                                        </div>
                                    </div>
						...
						<button style="background-color:orange;"
							...
							<div class="row gutters-5">
								...
								<div class="col-md">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Values" name="service_value[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="home-banner3-target">
                            ...
                            <div class="row gutters-5">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                ...
                                                <input type="hidden" name="service_video_images[]" class="selected-files" value="">
                                            </div>
                                            <div class="file-preview box sm">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="http://" name="service_video_links[]" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-auto">
                                        <div class="form-group">
            ...
            <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="total_employee" value="1" min="0" step="1" class="form-control">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="min_order" value="1" min="0" step="1" class="form-control">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="total_projects" value="1" min="0" step="1" class="form-control">
                        </div>
                    </div>
                </div>
