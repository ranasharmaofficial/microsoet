		...
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
						<label class="col-md-2 col-from-label">{{translate('Top Premium Brands')}}</label>
						<div class="col-md-10">
							<input type="hidden" name="types[]" value="top10_brands">
							<select name="top10_brands[]" class="form-control aiz-selectpicker" multiple data-max-options="100" data-live-search="true" data-selected="{{ get_setting('top10_brands') }}">
