        ...
        <div class="card">
            ...
            <div class="card-body add-new-style">
                <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                             <select class="select2 form-control aiz-selectpicker" name="parent_id" id="parent_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                <option value="0">{{ translate('--- Choose Main Category Then Edit Name --- ') }}</option>
					...
					<div class="form-group row">
                        ...
                        <div class="col-md-9">
                             <select class="form-control" id="subcategory_id" name="parent_id1" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                ...
                                <option value="0">{{ translate('--- Choose Subcategory Then Edit Name --- ') }}</option>
                            </select>
                        </div>
                    </div>
                    
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Select Third Category')}}</label>
                        <div class="col-md-9">
                             <select class="form-control" id="thirdcategory_id" name="parent_id2" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                
                                <option value="0">{{ translate('--- Choose Third Category Then Edit Name ---  ') }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="height375">
                    <div class="col-md-9 width30 fr brdrfull maincatbox marginminusright"> 
                    
                    <strong class="dblock">Create</strong><strong class="dblock">Main</strong><strong class="dblock">Category</strong>
                    </div>
                    
                    <div class="col-md-9 brdrfull width30 fr marginminusright submitbtnadd" style="margin-top:10px;"><button type="submit" class="btn btn-primary">Submit</button></div>
                    ...
                    <!--<div class="form-group row brdrtop">
                        <label class="col-md-3 col-form-label">{{translate('Edit Category Fielled')}}</label>
                        
                    </div>-->
                    <div class="form-group row brdrtop">
                    <label class="col-md-3 col-form-label">{{translate('Edit Category Filled')}}</label>
                    </div>
                    <div>
                    
                    <div class="form-group row width30 fl">
                        <label class="col-md-3 col-form-label">{{translate('Current Category Name')}}</label>
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Earth Movers')}}" id="name" name="name" class="form-control" required>
                        </div>
                        </div>
                        
                        <div class="form-group row width70 fr">
                        <label class="col-md-3 col-form-label">{{translate('Current Category Name')}}</label>
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Create Main Category, Subcategory, Third category')}}" id="name1" name="name1" class="form-control" required>
                        </div>
                        </div>
                    ...
                    <div class="form-group row width30 fl">
                        ...
                        <div class="col-md-9">
                            <select name="digital1" required class="form-control aiz-selectpicker mb-2 mb-md-0">
                                <option value="0">{{translate('Product')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row width70 fr">
                        <label class="col-md-3 col-form-label">{{translate('Parent Type')}}</label>
                        <div class="col-md-9">
                            <select name="digital2" required class="form-control aiz-selectpicker mb-2 mb-md-0">
                                <option value="0">{{translate('---Construction Tool---')}}</option>
                            </select>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group row corder">
                    <div class="col-md-4 fl">
                            <label class="">Create Order Number</label>
                            <input type="number"  name="order_level" class="form-control" id="order_no" placeholder="{{translate('Create Order Level')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="file-preview box sm"><div class="d-flex justify-content-between align-items-center mt-2 file-preview-item" data-id="522" title="ser20.jpg"><div class="align-items-center align-self-stretch d-flex justify-content-center thumb"><img src="//ebb.orrish.org/public/uploads/all/6knG1XrW6JfCdYNAlXXrRdFGUb8EJexMRHaR8KFS.jpg" class="img-fit"></div><div class="col body"><h6 class="d-flex"><span class="text-truncate title">ser20</span><span class="ext flex-shrink-0">.jpg</span></h6><p>123 KB</p></div><div class="remove"><button class="btn btn-sm btn-link remove-attachment" type="button"><i class="la la-close"></i></button></div></div></div>
                        </div>
                    </div>
					<div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="slug" placeholder="{{translate('earth-movers')}}">
                        </div>
                    </div>
                    <div class="form-group row">
