                    ...
                    <div class="form-group p-3">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select id="parent_id" class="from-control aiz-selectpicker" name="parent_id" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="subcategory_id" class="from-control sub-category" name="parent_id_one" required>
