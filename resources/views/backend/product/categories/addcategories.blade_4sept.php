    ...
    <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Add Category')}}</h5>
            </div>
            <div class="card-body add-new-style">
                <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Select Category Type')}}</label>
                        <div class="col-md-9 brdrbottom" style="padding:0 0px;">
                        <div class="col-md-9 width70 fl">
                        <ul class="clist"><li><input name="ctype" value="products" type="radio" id="products" ><label for="products">Products</label></li><li><input name="ctype" value="products" type="radio" id="Category" ><label for="Category">Category</label></li>
                        </ul></div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                             <select class="select2 form-control aiz-selectpicker" name="parent_id" id="parent_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                <option value="0">{{ translate('Create New Category') }}</option>
