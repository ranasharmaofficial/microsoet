        ...
        <form class="" id="sort_products" action="" method="GET">
            <div class="card-header row gutters-5">
                ...
                <div class="dropdown col-md-2 ml-auto">
                    <a class="btn btn-danger" href="{{ route('get_product_data.export') }}">
                        {{ translate('Export') }}
                    </a>
            ...
            <div class="card-header row gutters-5">
                ...
                <div class="col-md-2 mb-2">
                    <select class="form-control" id="secondcategory" onchange="category2(this.value);"
                ...
                <div class="col-md-2 mb-2">
                    <div class="d-flex">
                        <button type="button" id="find" class="btn btn-warning mr-2"
                            onclick="sort_products()">Find</button>
                        @if ($type == 'All')
                    ...
                    <tbody>
                        @foreach ($products as $key => $product)
                            <tr>
                                ...
                                <td>
                                    {{ optional($product->stocks->first())->sku }}
                                </td>
                                <td>
