...
<!--                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-3">
							...
							<div class="col-sm-9">
                                ...
                                <div class="form-group" id="discount_table1">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Is Top Product')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-6 col-from-label">{{translate('Is Top Product')}}</label>
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="is_top_product" value="1" @if($product->is_top_product == 1) checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
            ...
            function get_related_products_edit(){
                ...
                if(product_ids.length > 0){
                    $.post('{{ route('products.related_products_edit') }}', {_token:'{{ csrf_token() }}', product_ids:{{ $productss->id }}, items_id:product_ids}, function(data){
                        $('#discount_table1').html(data);
                        AIZ.plugins.fooTable();
                    });
                }
                else{
                    $('#discount_table1').html(null);
                }
            }
        });
