...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Add New Product Master')}}</h5>
</div>
<div class="add-new-style">
    <form class="" action="{{route('productmasters.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-12 col-from-label">{{translate('Product Name')}}</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Item')}}</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="item_weight" placeholder="{{ translate('Item Weight)') }}" required>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="short_description" placeholder="{{ translate('Short Description') }}" maxlength="200">
                            </div>
                        </div>
                    </div>
