...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h1 class="mb-0 h6">{{ translate('Edit Product Master') }}</h5>
</div>
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('productmasters.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Item Weight')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" value="{{ $product->item_weight }}" class="form-control" name="item_weight" placeholder="{{ translate('Item Weight)') }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Item Unit')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <select type="text" aiz-selectpicker data-live-search="true" class="form-control" name="item_unit" required>
                                    <option  @if($product->item_unit == 'kg') selected @endif  value="kg">KG</option>
                                    <option @if($product->item_unit == 'gram') selected @endif value="gram">Gram</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row" id="quantity">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" lang="en" value="{{ ($product->current_stock) }}" step="1" placeholder="{{translate('Quantity')}}" name="current_stock" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="{{ translate('SKU') }}" value="{{ ($product->sku) }}" name="sku" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="short_description" value="{{$product->short_description}}" placeholder="{{ translate('Short Description') }}" maxlength="200">
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
