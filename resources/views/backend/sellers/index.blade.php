        ...
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-2 dropdown mb-2 mb-md-0">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="{{ route('approved_seller.export') }}">{{translate('Approved Seller')}}</a>
                    <a class="dropdown-item" href="{{ route('unapproved_seller.export') }}">{{translate('Non Approved Seller')}}</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input onchange="update_approved(this)" value="{{ $seller->id }}" type="checkbox" <?php if($seller->user->is_verified == 1) echo "checked";?> >
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                        ...
                                        {{-- <a href="{{route('sellers.show', encrypt($seller->id))}}" class="dropdown-item">
                                          {{translate('View')}}
                                        </a> --}}
