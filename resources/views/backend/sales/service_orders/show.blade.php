                ...
                <table class="table table-bordered aiz-table invoice-summary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key+1 }}</td>
                            <td>
                                @if ($orderDetail->service != null)
                                    <a href="{{ route('service', $orderDetail->service->slug) }}" target="_blank"><img height="50" src="{{ uploaded_asset($orderDetail->service->thumbnail_img) }}"></a>
                                @else
                            ...
                            <td>
                                @if ($orderDetail->service != null)
                                    <strong><a href="{{ route('service', $orderDetail->service->slug) }}" target="_blank" class="text-muted">{{ $orderDetail->service->getTranslation('name') }}</a></strong>
