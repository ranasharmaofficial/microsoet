...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h4 class="fw-bold py-3 mb-4">{{ translate('All Product Orders') }}</h4>
        </div>
...
<div class="card">
    <form class="" action="" id="sort_orders" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('All Product Orders') }}</h5>
            </div>
        ...
        <div class="card-body">
            <table class="table aiz-table mb-0">
                ...
                <tbody>
					...
					@php
						$count_order_details = \App\Models\OrderDetail::where('combined_order_id', $order->id)->count();
						$order_table_details = \App\Models\Order::where('combined_order_id', $order->id)->first();
						$user_details = \App\Models\User::where('id', $order_table_details->user_id)->first();
					@endphp
                    <tr>
    <!--                    <td>
                        ...
                        <td>
                            @if ($order_table_details->payment_status == 'paid')
