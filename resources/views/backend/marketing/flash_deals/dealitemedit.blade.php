...
<div class="row">
    <div class="col-lg-10 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('flash_deals_item.update') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-lg-9">
                         ...
                         $dealdata =  \DB::table('flash_deals')->get();
                            ...
                            <select name="deal_id" id="type" class="form-control aiz-selectpicker" required>
                                ...
                                <option @if($deal_item->deal_id==$deal->id) selected @endif value="{{ $deal->id }}">{{ $deal->title }}</option>
                                @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Title')}}" id="name" name="title" value="{{$deal_item->title}}" class="form-control" required>
                        </div>
                    </div>
                      <div class="form-group row">
                        <label class="col-sm-3 control-label" for="name">{{translate('Sub Title')}}</label>
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Sub Title')}}" id="name" name="sub_title"  value="{{$deal_item->sub_title}}" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="url" placeholder="{{translate('Page link')}}" id="name" name="page_link"  value="{{$deal_item->page_link}}" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="banner" value="{{$deal_item->image}}"  class="selected-files">
                            </div>
