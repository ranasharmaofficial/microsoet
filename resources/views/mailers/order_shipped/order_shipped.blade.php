...
<table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr style="padding:0 0px; margin:0 0px; height:90px; clear:both; overflow:hidden; display:block;">
    <td><img src="{{static_asset('mailer/order_shipped/images/password_reset_01.jpg') }}" width="700" height="91" alt=""></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="328"><img src="{{static_asset('mailer/order_shipped/images/password_reset_02.jpg') }}" width="302" height="69" alt=""></td>
    <td width="69"><a href="#"><img src="{{static_asset('mailer/order_shipped/images/offer.jpg') }}" alt="" border="0"></a></td>
    <td width="96"><a href="#"><img src="{{static_asset('mailer/order_shipped/images/dapp.jpg') }}" alt="" border="0"></a></td>
    <td width="79"><a href="#"><img src="{{static_asset('mailer/order_shipped/images/visitweb.jpg') }}" alt="" border="0"></a></td>
    <td width="128" align="right"><img src="{{static_asset('mailer/order_shipped/images/password_reset_04.jpg') }}" width="109" height="69" alt=""></td>
  </tr>
</table>
</td>
  </tr>
  <tr>
    <td style="padding:0 0px; margin:0 0px; height:222px; clear:both; overflow:hidden; display:block;"><img src="{{static_asset('mailer/order_shipped/images/order_shipped_03.jpg') }}" width="700" height="223" alt=""></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="113"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_04.jpg') }}" width="113" height="119" alt=""></td>
    <td align="left" style="color:#321100; font-size:16px; font-family:Gilroy-Medium, Verdana, Geneva, sans-serif, Georgia, 'Times New Roman', Times, serif, Tahoma, Geneva, sans-serif;">
      Dear {{$order->user->name}}, Once your order has been reviewed & processed,
      you will be notified of your next steps.<br/>
      Thankyou<br/></br>
    ...
    <td width="99"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_06.jpg') }}" width="99" height="119" alt=""></td>
  </tr>
</table>
</td>
  </tr>
  <tr>
    <td style="padding:0 0px; margin:0 0px; height:182px; clear:both; overflow:hidden; display:block;"><img src="{{static_asset('mailer/order_shipped/images/order_shipped_07.jpg') }}" width="700" height="183" alt=""></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="113"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_08.jpg') }}" width="113" height="112" alt=""></td>
...
methods for future orders.</strong></td>
    <td width="233"><img src="{{static_asset('mailer/order_shipped/images/order_shipped_10.jpg') }}" width="233" height="112" alt=""></td>
  </tr>
</table>
</td>
  </tr>
  ...
  <tr>
    <td width="113"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_11.jpg') }}" width="113" height="110" alt=""></td>
...
<a href="#" style="color:#5a1da2;">Click here</a> to access your newly purchased products and services.</td>
    <td width="233"><img src="{{static_asset('mailer/order_shipped/images/order_shipped_13.jpg') }}" width="233" height="110" alt=""></td>
  </tr>
</table>
</td>
  </tr>
  ...
  <tr>
    <td width="70" valign="top" bgcolor="f2f5fa"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_14.jpg') }}" width="70"  alt=""></td>
  ...
  <tr>
    <td width="102"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_17.jpg') }}" width="102" height="61" alt=""></td>
...
know what you think over <a href="#" style="color:#a84a4f;">here</a>.</strong></td>
    <td width="90"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_19.jpg') }}" width="90" height="61" alt=""></td>
  </tr>
</table>
</td>
  </tr>
  ...
  <tr>
    <td width="154"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_20.jpg') }}" width="154" height="156" alt=""></td>
  ...
  <tr>
    <td style="height:38px; overflow:hidden;"><img src="{{static_asset('mailer/order_shipped/images/payment_confirmation_21.jpg') }}" width="393" height="39" alt=""></td>
  </tr>
  <tr>
...
For any questions, email us anytime here at:<br /><a href="mailto:info@ebuildbazaar.in" style="color:#ffffff; font-size:14px; font-family:Gilroy-Heavy, Verdana, Geneva, sans-serif, Georgia, 'Times New Roman', Times, serif, Tahoma, Geneva, sans-serif; text-decoration:none;">info@ebuildbazaar.in</a></td>
    ...
    <td width="153"><img src="{{static_asset('mailer/order_shipped/images/order_shipped_22.jpg') }}" width="153" height="156" alt=""></td>
  </tr>
</table>
</td>
  </tr>
  ...
  <tr>
    <td width="163" align="left"><img src="{{static_asset('mailer/order_shipped/images/feedback_13.jpg') }}" width="107" height="52" alt=""></td>
...
please click <a href="#" style="color:#381705; font-size:12px; font-family:Gilroy-Medium, Verdana, Geneva, sans-serif, Georgia, 'Times New Roman', Times, serif, Tahoma, Geneva, sans-serif;">here</a>.</td>
    <td width="144" align="right"><img src="{{static_asset('mailer/order_shipped/images/feedback_15.jpg') }}" width="109" height="52" alt=""></td>
  </tr>
</table>
</td>
  </tr>
  <tr>
    <td style="padding:0 0px; margin:0 0px; height:52px; clear:both; overflow:hidden; display:block;"><img src="{{static_asset('mailer/order_shipped/images/password_reset_19.jpg') }}" width="700" height="53" alt=""></td>
  </tr>
  <tr>
    <td bgcolor="#ffe7cd" style="padding:0 0px; margin:0 0px; height:56px; clear:both; overflow:hidden; display:block;">
    <table width="700" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="197" align="left"><img src="{{static_asset('mailer/order_shipped/images/password_reset_20.jpg') }}" width="197" height="57" alt=""></td>
    <td width="115" align="center"><a href="#"><img src="{{static_asset('mailer/order_shipped/images/password_reset_21.jpg') }}" width="55" height="57" alt="" border="0"></a></td>
    <td width="70" align="center"><a href="#"><img src="{{static_asset('mailer/order_shipped/images/password_reset_22.jpg') }}" width="57" height="57" alt="" border="0"></a></td>
    <td width="118" align="center"><a href="#"><img src="{{static_asset('mailer/order_shipped/images/password_reset_23.jpg') }}" width="54" height="57" alt="" border="0"></a></td>
    <td width="200" align="right"><img src="{{static_asset('mailer/order_shipped/images/password_reset_24.jpg') }}" width="200" height="57" alt=""></td>
  </tr>
</table>
  ...
  <tr>
    <td align="left" valign="top"><img src="{{static_asset('mailer/order_shipped/images/password_reset_25.jpg') }}" width="107" height="230" alt=""></td>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><img src="{{static_asset('mailer/order_shipped/images/password_reset_26_1.jpg') }}" height="26" alt=""></td>
  </tr>
  <tr>
...
(eBB) in India & other countries.
    ...
    <td align="right" valign="top"><img src="{{static_asset('mailer/order_shipped/images/password_reset_27.jpg') }}" width="80" height="230" alt=""></td>
  </tr>
</table>
</td>
  </tr>
