         ...
         <div class="row">
            <div class="col-12">
               <div class="navbar-top">
                  ...
                  <img src="images/logo 78.png" class="img-fluid blur-up lazyload" alt="">
                  </a>
                                 ...
                                 <ul class="cart-list">
                                    <li class="product-box-contain">
                                       <div class="drop-cart">
                                          ...
                                          <img src="images/hp2.png" class="blur-up lazyloaded" alt="">
                                          </a>
                                          <div class="drop-contain">
                                             <a href="product-left-thumbnail.html">
                                                <h5>Fantasy Crunchy Choco Chip CookiesHP All-in-One PC Ryzen 5 7520U 27-inch(68.6cm) FHD IPS Display, 16GB LPDDR5, 1TB SSD, AMD Radeon Graphics, Wireless Keyboard and mouse combo, FHD Camera, (Win 11, MSO, Shell White,</h5>
                                             </a>
                  ...
                  <div class="category-dropdown">
                     ...
                     <ul class="category-list">
                        <li class="onhover-category-list">
                           <a href="https://superkart-demo-02.mybigcommerce.com" class="category-name">
                              <img src="images/all_brands.png" alt="">
                              <h6>All Brands</h6>
                           ...
                           <div class="onhover-category-box">
                              <div class="list-1">
                                 ...
                                 <ul>
                                    ...
                                    <li>
                                       <a href="javascript:void(0)">Lenvo</a>
                                    </li>
                                    <li>
                        ...
                        <li class="onhover-category-list">
                           ...
                           <div class="onhover-category-box w-100">
                              <div class="list-1">
                                 ...
                                 <ul>
                                    <li>
                                       <a href="javascript:void(0)">HIKVISION</a>
                                    </li>
                                    <li>
                                       <a href="javascript:void(0)">PRAMA</a>
                                    </li>
                                    <li>
                                       <a href="javascript:void(0)">Zeblon</a>
                                    </li>
                                    <li>
                                       <a href="javascript:void(0)">XCP PLUS</a>
                                    </li>
                                    <li>
                                       <a href="javascript:void(0)">UNV</a>
                                    </li>
                                    <li>
                                       <a href="javascript:void(0)">HI-Foucs</a>
                                    </li>
                                    <li>
                                       <a href="javascript:void(0)">Ahua</a>
                                    </li>
                                    <li>
                                       <a href="javascript:void(0)">HoneyWell</a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                        ...
                        <li class="onhover-category-list">
                           <a href="javascript:void(0)" class="category-name">
                              <img src="images/accessory.png" alt="">
                              <h6>Accessories</h6>
                              <i class="fa-solid fa-angle-right"></i>
                           </a>
                           <div class="onhover-category-box">
                        ...
                        <div class="offcanvas-body">
                           <ul class="navbar-nav">
                              ...
                              <li class="nav-item dropdown">
                                 <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown">All Categories
                                 </a>
                              ...
                              <li class="nav-item dropdown">
                                 <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown">desktop
                                 </a>
                                 <ul class="dropdown-menu">
                                    <li>
                              ...
                              <li class="nav-item dropdown">
                                 <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown">Laptop
                                 </a>
                                 <ul class="dropdown-menu">
                                    <li>
                                       <a class="dropdown-item" href="#">Dell</a>
                              ...
                              <li class="nav-item dropdown">
                                 <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown">Printer
                                 </a>
                                 <ul class="dropdown-menu">
                                    <li>
                                       <a class="dropdown-item" href="#">HP</a>
                              ...
                              <li class="nav-item dropdown">
                                 <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown">CCTV
                                 </a>
                                 <ul class="dropdown-menu">
                                    <li>
               ...
               <ul class="about-list right-nav-about">
                  <li class="right-nav-list">
                     <div class="dropdown theme-form-select">
                        ...
                        <img src="../assets/images/country/united-states.png" class="img-fluid blur-up lazyloaded" alt="">
                        <span>English</span>
                        </button>
