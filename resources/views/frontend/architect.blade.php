      ...
      <div class="container">
        ...
        <div class="row photos my-3">
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{ static_asset('assets_web/img/build-expertisE1.jpg')}}" data-lightbox="photos" class="lb_all-link">
              <img class="img-fluid" src="{{ static_asset('assets_web/img/build-expertisE1.jpg')}}"/>
            </a>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{ static_asset('assets_web/img/build-expertisE2.jpg')}}" data-lightbox="photos" class="lb_all-link"
              ><img class="img-fluid" src="{{ static_asset('assets_web/img/build-expertisE2.jpg')}}" />
            </a>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{ static_asset('assets_web/img/build-expertisE3.jpg')}}" data-lightbox="photos" class="lb_all-link"
              ><img class="img-fluid" src="{{ static_asset('assets_web/img/build-expertisE3.jpg')}}" />
            </a>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{ static_asset('assets_web/img/build-expertisE4.jpg')}}" data-lightbox="photos" class="lb_all-link"> 
              <img class="img-fluid" src="{{ static_asset('assets_web/img/build-expertisE4.jpg')}}" />
            </a>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{ static_asset('assets_web/img/build-expertisE1.jpg')}}" data-lightbox="photos" class="lb_all-link">
