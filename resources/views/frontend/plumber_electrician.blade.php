      ...
      <div class="container">
        <div class="build_tag-banner pt-3 w-30 h-450 left-0 background-white text-left">
          <div class="row">
            ...
            @php
              $form_type = 'plumber_elctrician_page';
            @endphp  
      ...
      <div class="container">
        ...
        <div class="row photos my-3">
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{ static_asset('assets_web/img/plumbing-contractor.png')}}" data-lightbox="photos" class="lb_all-link">
              <img class="img-fluid" src="{{ static_asset('assets_web/img/plumbing-contractor.png')}}"/>
            </a>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{ static_asset('assets_web/img/plumbing-contractor.png')}}" data-lightbox="photos" class="lb_all-link">
