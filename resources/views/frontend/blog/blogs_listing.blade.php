...
@section('content')
<section class="pageTitle" style="background-image:url({{ static_asset('assets_web/img/blog-banner-designs.png') }});    height: 246px;">
                                    ...
                                    <div class="list-post">
                                        <div class="list-post-media">
                                            <a href="{{ url("blog").'/'. $blog->slug }}">
                                                <div class="bg-wrap">
                                                    <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset($blog->banner) }}" alt="{{ $blog->title }}">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="list-post-content">
                                            <h3 class="mb-2 mt-3"><a href="{{ url("blog").'/'. $blog->slug }}">{{ $blog->title }}</a></h3>
                                            <span class="post-date"><i class="far fa-clock"></i> {{ date('d-M-Y', strtotime($blog->created_at)) }}</span>
                                            <p>{{ $blog->short_description }}</p>
                                            <a class="post-category-marker" href="{{ url("blog").'/'. $blog->slug }}">View More</a>
                                        </div>
                                    </div>
                                </div>
                                <!--list-post end-->
