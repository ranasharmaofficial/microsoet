                ...
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        <form id="login-form" class="form active">
                            ...
                            <span class="py-2 d-inline-block" style="color:#a68f8f">Welcome back! Sign in to your vendor
                                account.</span>
                            <input type="number" placeholder="Enter Your Mobile Number" required class="login-number-login"
                                pattern="[0-9]{1}" inputmode="numeric" name="phone">
                            <button type="submit" class="login-btn" id="login-send-otp">Send one time password</button>
                            <div id="login-otp-input-box" class="w-full" style="display:none;">
                                <div class="form-group w-full">
                                    <input type="tel" class="form-control border rounded mt-3" name="otp"
                                        id="login-otp-input" placeholder="Enter OTP*" disabled required>
                                </div>
                        ...
                        <form id="signup-form" class="form">
                            ...
                            <div class="form-group">
                                ...
                                <span class="py-2 d-inline-block" style="color:#a68f8f">Create new vendor account today and
                                    reap the benefits of a personalized shopping experience</span>
                                <div class="d-flex col-lg-6 gap-2">
                                    <input type="text" class="form-control  col-lg-6" name="name" placeholder="Enter your Name" id="name"
                                        required>
                                    <input type="email" class="form-control  col-lg-6" name="email" placeholder="Enter your Email" id="email"
                                        required>
                                </div>
                                <div class="d-flex col-lg-6 gap-2">
                                    <input type="text" class="form-control col-lg-6" name="shop_name"
                                        placeholder="Enter your Shop Name" required id="shop_name">
                                    <input type="text" class="form-control col-lg-6" name="gst"
                                        placeholder="Enter your GST No." required id="gst">
                                </div>
                                <input type="text" class="form-control" name="shop_address"
                                    placeholder="Enter your Shop Address" required id="shop_address">
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#send-otp').on('click', function() {
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ route('send.vendor.phone.otp') }}",
                    data: {
                        phone: phone,
                        _token: "{{ csrf_token() }}"
                    },
            ...
            $('#signup-form').on('submit', function(event) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ route('verify.vendor.phone.otp') }}",
                    data: {
                        name: name,
                        email: email,
                        gst: gst,
