                                        ...
                                        @foreach ($orders as $key => $order_cancel)
                                            @if (count($order_cancel->orderDetails) > 0)
                                                <li class="ukine ukine1b active4">
                                                    <div class="row border-bottom pb-2 mb-4">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                                            <div class="order_detail-btn">
                                                                ...
                                                                <a href="{{url('order-details/'.$order_cancel->id)}}" class="mt-1 order_btn text-capitalize ">
                                                                    Order Detail
                                                                </a>
                                                    ...
                                                    {{-- @php
                                                        dd($order_cancel->order_details[0]->product);
                                                    @endphp --}}
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="row">
                                                                            <div class="col-lg-12 col-md-12 col-sm-3 col-xs-12">
                                                                                <p class="order_listing text-capitalize my-1 torder">
                                                                                    <a href="{{url('track-your-order?order_code='.$order_cancel->code)}}">
                                                                            ...
                                                                            <div class="col-lg-12 col-sm-3">
                                                                                <p class="order_listing text-capitalize my-1 torder">
                                                                                    <a href="{{ route('invoice.download', $order_cancel->id) }}">
                                                                        ...
                                                                        @if($key->delivery_status == 'pending' && $key->payment_status == 'unpaid')
                                                                            <div class="col-lg-12 col-sm-3">
                                                                                <p class="order_listing text-capitalize my-1 torder">
                                                                                    <a href="{{url('purchase_history/order_cancel/'.$order_cancel->id)}}">
                                                                        ...
                                                                        <div class="row align-items-center flex-column">
                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-12 col-sm-3">
                                                                                        <p class="order_listing text-capitalize my-1 torder">
                                                                                            <a href="javascript:void(0);" onclick="showOrderDetails(this)" id="{{$key->id}}">
                                                                                            <span class="icon rounded-circle py-1 px-1 d-inline-block bg-danger text-center m-auto">
                                                                                                    <i class="fa fa-undo mx-2 text-white text-center"></i>
                                                                                                </span>
                                                                                                <span class="txth">Return Order</span>
                                                                                            </a>
                                                                                        </p>
                                                                                    </div>
