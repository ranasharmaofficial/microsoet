                     ...
                     <div class="dashboard-left-sidebar">
                         ...
                         <div class="profile-box">
                             <div class="cover-image">
                                 <img src="{{ static_asset('assets_web/images/inner-page/cover-img.jpg') }}"
                                 ...
                                 <div class="profile-image">
                                     <div class="position-relative">
                                         @if (Auth::user()->avatar != null)
                                             <img src="{{ static_asset('uploads/user/' . Auth::user()->avatar) }}"
                                                 class="blur-up lazyload update_img" alt="">
                                         @else
                                             <img src="{{ static_asset('assets_web/images/inner-page/user/1.jpg') }}"
                                                 class="blur-up lazyload update_img" alt="">
                                         @endif
                             ...
                             <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel">
                                 <div class="dashboard-home">
                                     ...
                                     <div class="dashboard-user-name">
                                         <h6 class="text-content">Hello, <b class="text-title">{{ Auth::user()->name }}</b>
                                         </h6>
                                     ...
                                     <div class="total-box">
                                         <div class="row g-sm-4 g-3">
                                             ...
                                             <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                 <div class="total-contain">
                                                     <img src="{{ static_asset('assets_web/images/svg/pending.svg') }}"
                                                         class="img-1 blur-up lazyload" alt="">
                                                     <img src="{{ static_asset('assets_web/images/svg/pending.svg') }}"
                                                         class="blur-up lazyload" alt="">
                                                     <div class="total-detail">
