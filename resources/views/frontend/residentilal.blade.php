...
@section('content')
  ...
  {{-- <section class="pageTitle p-0" style="background-image: url({{static_asset('assets_web/img/slider4a.jpg')}}); height: 375px"> --}}
    <section class="pageTitle p-0" style="background-image: url({{static_asset('assets_web/img/slider4a.jpg')}});height: 375px; background-size: cover;">
    <div class="container">
      <div class="build_tag-banner pt-3 w-30 h-450 left-0 background-white text-left">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            @php
            $form_type = 'resedential_page';
          @endphp  
    ...
    <div class="container">
      ...
      <div class="row photos my-3">
        <div class="col-sm-6 col-md-4 col-lg-3 item">
          <a href="{{ static_asset('assets_web/img/residential-architects.png')}}" data-lightbox="photos" class="lb_all-link">
            <img class="img-fluid" src="{{ static_asset('assets_web/img/residential-architects.png') }}" />
          </a>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-3 item">
          <a href="{{ static_asset('assets_web/img/residential-architects.png')}}" data-lightbox="photos" class="lb_all-link">
