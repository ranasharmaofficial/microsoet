        ...
        <div class="container-fluid-lg">
			...
			{{-- <div class="col-xxl-3 col-xl-4 d-none d-xl-block">
                ...
                <div class="col-xxl-12 col-xl-12">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/pc3 (1).png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    <a href="product-left-thumbnail.html">
                                                        <h6 class="name">Cyntexia Computer Desktop Gaming PC (Core
                                                            i7-4770 | 16GB RAM | 512GB SSD | GT 730 4GB DDR3 GPU | Ethernet
                                                            | Win 10) Basic Software Installed
                                                        </h6>
                                                    </a>
                                                    <h5 class="sold text-content">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                ...
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/hpe.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    <a href="product-left-thumbnail.html">
                                                        <h6 class="name">Zoonis i7 Gaming Pc Full Setup Desktop Complete
                                                            Computer Core I7 2600 |16GB Ram |512GB SSD| |Windows 10| GT 4GB
                                                            730 Graphics Card with 19 inches led Monitor RGB Keyboard Mouse
                                                            Wi-fi Ready to Play</h6>
                                                    </a>
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">22,655</span>
                                                        <del>25,000</del>
                                                    </h5>
                                                    <div class="product-rating mt-sm-2 mt-1">
                                                        <ul class="rating">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/yr4.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    ...
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">₹55,948.32
                                                        </span>
                                                        <del>₹69,072.00 </del>
                                                    </h5>
                                                    <div class="product-rating mt-sm-2 mt-1">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/hue.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    ...
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">₹39,687.23
                                                        </span>
                                                        <del>₹50,237.00 </del>
                                                    </h5>
                                                    <div class="product-rating mt-sm-2 mt-1">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                ...
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/t6.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    <a href="product-left-thumbnail.html">
                                                        <h6 class="name">HP Laserjet Tank 1005 Print+Copy+Scan, Lowest
                                                            Cost/Page - B&W Prints, Easy 15 Sec Toner Refill, Smart Guided
                                                            Buttons, Best for Business
                                                            pcs
                                                        </h6>
                                                    </a>
                                                    <h5 class="sold text-content">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/oq.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    <a href="product-left-thumbnail.html">
                                                        <h6 class="name">HP Smart Tank 585 AIO (Print, Scan & Copy) WiFi
                                                            Colour Printer for Office/Home (Upto 6000 Black and 6000 Colour
                                                            Prints Included in The Box); Claim Fireboltt Smartwatch
                                                            pcs
                                                        </h6>
                                                    </a>
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">₹14,799.00
                                                        </span>
                                                        <del>₹17,799.00
                                                        </del>
                                                    </h5>
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/cctveone.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    ...
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">₹ 4,000/ Piece</span>
                                                        <del>₹ 10,000/ Piece</del>
                                                    </h5>
                                                    <div class="product-rating mt-sm-2 mt-1">
                                                        <ul class="rating">
                                                            <li>
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/OIP.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    <a href="product-left-thumbnail.html">
                                                        <h6 class="name">Hikvision ECO Series 2MP CCTV Camera |
                                                            DS-2CE1AD0T-IP/ECO LITE
                                                        </h6>
                                                    </a>
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">₹1,655</span>
                                                        <del>₹2,655</del>
                                                    </h5>
                                                    <div class="product-rating mt-sm-2 mt-1">
                                                        <ul class="rating">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/mouse.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    ...
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">150</span>
                                                        <del>250</del>
                                                    </h5>
                                                    <div class="product-rating mt-sm-2 mt-1">
                                                        <ul class="rating">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('public/assets_web/images/y7.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="product-detail">
                                                    <a href="product-left-thumbnail.html">
                                                        <h6 class="name">Supplay
                                                        </h6>
                                                    </a>
                                                    <h5 class="sold text-content">
                                                        <span class="theme-color price">2,000</span>
                                                        <del>1,000</del>
                                                    </h5>
                                                    <div class="product-rating mt-sm-2 mt-1">
                                                        <ul class="rating">
                    ...
                    <div class="title">
                        <h2>Bowser by Categories</h2>
                        <span class="title-leaf">
                            <svg class="icon-width">
                                <use xlink:href="{{ asset('public/assets_web/images/svg/leaf.svg') }}"></use>
                            </svg>
                        </span>
                    ...
                    <div class="category-slider-2 product-wrapper no-arrow">
                        <div>
                            <a href="shop-left-sidebar.html" class="category-box category-dark">
                                <div>
                                    <img src="{{ asset('public/assets_web/images/television.png') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>T.V</h5>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-box category-dark">
                                <div>
                                    <img src="{{ asset('public/assets_web/images/laptop-screen.png') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>Laptop</h5>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-box category-dark">
                                <div>
                                    <img src="{{ asset('public/assets_web/images/cctv-camera.png') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>CCTV</h5>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-box category-dark">
                                <div>
                                    <img src="{{ asset('public/assets_web/images/printer (1).png') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>Printer</h5>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-box category-dark">
                                <div>
                                    <img src="{{ asset('public/assets_web/images/mouse.png') }}"
                                        class="blur-up lazyload" alt="">
                                    <h5>Frozen Foods</h5>
                                </div>
                            </a>
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('public/assets_web/images/destoppro.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">HP All-in-One PC, Intel Processor N200,
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('public/assets_web/images/destoppro2.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">Acer EK220Q 21.5 Inch (54.61 cm) Full HD
                                                        (1920x1080) Pixels VA Panel LCD Monitor with LED Back Light I 1 MS
                                                        VRB, 100Hz Refresh I 250 Nits I HDMI & VGA Ports with HDMI Cable I
                                                        Eye Care Features (Black)</h6>
                                                </a>
                                                <h5 class="sold text-content">
                                                    <span class="theme-color price"> ₹4,999</span>
                                                    <del>30% Off</del>
                                                </h5>
                                                <div class="product-rating mt-sm-2 mt-1">
                                                    <ul class="rating">
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('public/assets_web/images/destop5.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">ASUS Vivo AiO V222, 4 core Intel Pentium Silver
                                                        J5040, 21.5" (54.61cm), All-in-One Desktop (8GB/256GB
                                                        SSD/Win11/1Year McAfee Security/Wired Keyboard & Mouse
                                                        Included/Black/4.8 kg), V222GAK-BA034W
                                                    </h6>
                                                </a>
                                                <h5 class="sold text-content">
                                                    <span class="theme-color price"> ₹27,990
                                                    </span>
                                                    <del> ₹37,990
                                                    </del>
                                                </h5>
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('public/assets_web/images/t6.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">Gaming Desktop Assembled Core i5 3rd Gen |
                                                        20inch Monitor| PC for Home & Business (16 GB DDR3 Ram/256 GB SSD+
                                                        1TB HDD /4GB Graphic Card/WiFi/Bluetooth | Keyboard Mouse|Windows 10
                                                        with MS Office
                                                    </h6>
                                                </a>
                                                <h5 class="sold text-content">
                                                    <span class="theme-color price"> ₹19,000</span>
                                                    <del>₹3,8999</del>
                                                </h5>
                                                <div class="product-rating mt-sm-2 mt-1">
                                                    <ul class="rating">
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('public/assets_web/images/9i.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">15-fb0040AX HP Victus AMD Ryzen 5-5600H 15.6
                                                        inches/39.6 cm FHD Gaming Laptop (8GB RAM/512GB SSD/GTX 1650 4GB
                                                        Graphics/144Hz/9ms Response Time/Windows 11/MSO/Backlit KB/B&O
                                                        Audio/Xbox Pass, 30 Day)
                                                    </h6>
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('public/assets_web/images/c2.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">IMOU 360° 1080P Full HD Security Camera, Human
                                                        Detection, Motion Tracking, 2-Way Audio, Night Vision, Dome Camera
                                                        with WiFi & Ethernet Connection, Alexa Google Assistant, Up to 256GB
                                                    </h6>
                                                </a>
                                                <h5 class="sold text-content">
                                                    <span class="theme-color price">₹1,299 </span>
                                                    <del>₹1,299 </del>
                                                </h5>
                                                <div class="product-rating mt-sm-2 mt-1">
                                                    <ul class="rating">
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('public/assets_web/images/iuy.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">HP Laserjet Tank 1005 Print+Copy+Scan, Lowest
                                                        Cost/Page - B&W Prints, Easy 15 Sec Toner Refill, Smart Guided
                                                        Buttons, Best for Business
                                                        pcs
                                                    </h6>
                                                ...
                                                <h5 class="sold text-content">
                                                    <span class="theme-color price">₹20,657.00
                                                    </span>
                                                    <del>₹20,657.00
                                                    </del>
                                                </h5>
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('public/assets_web/images/pod.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <div class="product-detail">
                                                <a href="product-left-thumbnail.html">
                                                    <h6 class="name h-100">Logitech C270 Digital HD Webcam with Widescreen
                                                        HD Video Calling, HD Light Correction, Noise-Reducing Mic, for
                                                        Skype, FaceTime, Hangouts, WebEx, PC/Mac/Laptop/MacBook/Tablet -
                                                        (Black,</h6>
                                                </a>
                                                <h5 class="sold text-content">
                                                    <span class="theme-color price">₹1,899</span>
                                                    <del>₹1,899</del>
                                                </h5>
                                                <div class="product-rating mt-sm-2 mt-1">
                                                    <ul class="rating">
