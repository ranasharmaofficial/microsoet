            ...
            <div class="col-md-12">
               <div class="bottom-form m-auto">
                  <div class="border-bottom1 border-color-111 mt-0 mb-3">
                     <h3 class="section-title section-title__sm mb-0 pt-2 pb-0 mt-0 font-size-18 text-left">LAND COLLABORATION &raquo; Builder/Collaborator
                     </h3>
            ...
            <div class="col-md-12">
               ...
               <div class="border-bottom1">
                  ...
                  <div class="col-md-3 mb-2"><input type="text" name="name" class="form-control br-radius-none" placeholder="Location" autocomplete="off"></div><div class="col-md-3 mb-2"><input type="text" name="name" class="form-control br-radius-none" placeholder="Pincode" autocomplete="off"></div><div class="col-md-4 col-sm-12 mb-2" style="margin-bottom: 10px; position:relative;"><i class="fa fa-angle-down" aria-hidden="true" style="position: absolute; z-index: 99; top: 15px; right:15px;"></i><select class="form-control br-radius-none" name="Building_Type" id="Building_Type">
                            ...
                            </select></div><div class="col-md-2 mb-2"><button class="filterbtn w-100"><i class="fa fa-filter" aria-hidden="true"></i> Filter</button></div>
                 </div>
