...
@section('content')
   ...
   <section class="pageTitle" style="background-image:url({{ static_asset('assets_web/img/order-free-sample.png') }});    height: 246px;">
        <div class="container"> </div>
    </section>
      <!--top banner end -->
      <div class="service-pros animated animate__fadeInUp wow product-categorys ulines-dps-para pb-5">
	   <div class="container">
	  <div class="row">
		 <div class="col-md-12 breadmcrumsize">
		   <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"> Design Explore    </li>
               </ol>
            </nav>
		 </div>
		 </div>
         ...
         <div class="container details-product product-catpro ">
            <div class="row">
               <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                  ...
                  <div class="mb-6">
				    <div class="border-bottom1 border-color-11 mt-0 mb-3">
                        <h3 class="section-title section-title__sm mb-0 pb-2 font-size-18 mt-0">Filter</h3>
						<div class="deals"> 
                     <hr>
                  </div>
                     </div>
 ...
 <form action="#">
		<div id="accordion" class="accordion-container contentsarround">
				...
				<article class="content-entry">
						 <h4 class="font-size-14 mb-3 font-weight-bold article-title"> Product category <i></i></h4>
                        ...
                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              ...
                              <label class="custom-control-label" for="categoryTshirt"> Structural Material <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="categoryShoes">
                              <label class="custom-control-label" for="categoryShoes">Plumbing <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="categoryAccessories">
                              <label class="custom-control-label" for="categoryAccessories">Electricals <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="categoryTops">
                              <label class="custom-control-label" for="categoryTops"> Sanitaryware <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="categoryBottom">
                              <label class="custom-control-label" for="categoryBottom">Home Appliances <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <!-- End Checkboxes -->
                        <!-- View More - Collapse -->
                        <div class="collapses2" id="collapseBrand1">
                           <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 ...
                                 <label class="custom-control-label" for="categoryShorts"> Kitchen <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="categoryHats">
                                 <label class="custom-control-label" for="categoryHats">Paints & Surface Care <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="categorySocks">
                                 <label class="custom-control-label" for="categorySocks">Hardware Tools <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="categorySocks">
                                 <label class="custom-control-label" for="categorySocks"> Tiles & Floorings <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                        </div>
                        <!-- End View More - Collapse -->
		...
		<button type="submit" class="addto btd">Apply Filter   </button>
<a href="#" id="ClearFilters" class="text-center py-3 w-100 d-block">Clear Filters</a>
		</div>
               ...
               <div class="col-xl-9 col-wd-9gdot5">
                  ...
                  <div class="row">
                     <div class="col-md-3">
                        <div class="product-box h-auto">
                         <a href="">
                           <img src="{{ static_asset('assets_web/img/bathroom-tiles.png')}}" alt="">
                           <div class="discrptions">
                            <h5>Bathroom Tiles </h5>
                              <h6>Item Code : 10001</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                         ...
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/ceramic-tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5>Ceramic Tile </h5>
                              <h6>Item Code : 10002</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                        <div class="product-box h-auto">
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/Cladding-tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5>Cladding Tile</h5>
                              <h6>Item Code : 10003</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                         <div class="product-box h-auto">
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/floor-tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5>Floor Tile </h5>
                              <h6>Item Code : 10004</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                        <div class="product-box h-auto">
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/glass-tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5>Glass Tile </h5>
                              <h6>Item Code : 10005</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                        <div class="product-box h-auto">
                         <a href="order-free-sample-detail.php">
                           <img src="{{ static_asset('assets_web/img/granite-tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5>Granite Tile </h5>
                              <h6>Item Code : 10007</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                         <div class="product-box h-auto">
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/kajaria-ceramics-tiles.png')}}" alt="">
                           <div class="discrptions">
                            <h5> Kajaria Ceramics Tiles  </h5>
                              <h6>Item Code : 10008</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                        <div class="product-box h-auto">
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/kitchen-tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5> Kitchen Tile</h5>
                              <h6>Item Code : 10009</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                         <div class="product-box h-auto">
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/Marble-tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5> Marble Tile </h5>
                              <h6>Item Code : 100010</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                        <div class="product-box h-auto">
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/outdoor-tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5>Outdoor Tile </h5>
                              <h6>Item Code : 100011</h6>
                           </div>
                         </a>
                     ...
                     <div class="col-md-3">
                        <div class="product-box h-auto">
                         <a href="javascript:void(0);">
                           <img src="{{ static_asset('assets_web/img/Porcelain-Tile.png')}}" alt="">
                           <div class="discrptions">
                            <h5>Porcelain Tile</h5>
                              <h6>Item Code : 100012</h6>
                           </div>
                         </a>
