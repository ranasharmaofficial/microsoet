      ...
      <div class="container">
        ...
        <div class="row photos my-3">
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{static_asset('assets_web/img/pros8.png')}}" data-lightbox="photos" class="lb_all-link">
              <img class="img-fluid" src="{{static_asset('assets_web/img/pros8.png')}}"/>
            </a>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="{{static_asset('assets_web/img/pros8.png')}}" data-lightbox="photos" class="lb_all-link">
