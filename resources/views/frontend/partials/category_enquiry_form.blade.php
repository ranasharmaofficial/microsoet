         ...
         <input type="hidden" name="page_name" value="Product">
            <div class="agent-details">
               <div class="d-flex align-items-center">
                  <div class="agent-image"><img class="rounded" src="{{ static_asset('assets/img/logo.png') }}" alt="Brittany Watkins" width="80"></div>
            ...
            <a href="tel:{{ env('CALL_NUMBER') }}" class="btn btn-secondary-outlined btn-half-width">
               <!-- <button type="button" class="btn"> -->
               <span class="hide-on-click">Call</span>
               <!-- </button> -->
            </a>
            <a target="_blank" href="{{ env('WHATSAPP_LINK') }}" class="btn btn-secondary-outlined btn-full-width mt-10"><i class="houzez-icon icon-messaging-whatsapp mr-1"></i> WhatsApp</a>
         </form>
      </div>
      <!-- property-form -->
   </div>
