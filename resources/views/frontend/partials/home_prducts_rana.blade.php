<div id="cat_product">			 
				@php 
					$pro_category = App\Models\Category::where('type', '1')->whereIn('id', [2,3,40,20])->get();
				...
				@if(count($pro_category)>0)
					...
					@php
						$product_lists = App\Models\Product::where('category_id', $category->id)->limit(10)->get();
					@endphp
