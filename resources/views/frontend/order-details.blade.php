...
<span>Return window closed on 31-Mar-2021</span> --}}
										...
										<div class="row p-2">
                                             <div class="col-md-12">
                                              <p class="pp-cart m-0"><b> {{ single_price($orderDetail->price) }}</b></p>
                                             </div>
									  ...
									  <a href="{{ route('product', $orderDetail->product->slug) }}"><button class="class_buy_again">Buy it Again</button>  </a>
