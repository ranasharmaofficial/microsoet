...
<div class="service-pros animated animate__fadeInUp wow product-categorys ulines-dps-para ">
                ...
                <div class="brand_product">
                    ...
                    <div class="row">
                        <div class="owl-carousel owl-theme category-slide-listing" id="master_product_list">
                            ...
                            @foreach($filter_master_products as $master_product)
                                <div class="item showboxzoom">
                                    <div class="col product-categorys product-categorys-listing">
                                        <div class="product_br">
                                            <input type="radio" id="first_cat_radio_{{$master_product->id}}" value="{{$master_product->id}}" name="master_product                                           " class="master_service_id">
                                            <a><label for="first_cat_radio_{{$master_product->id}}">
                                                <img src="{{uploaded_asset($master_product->thumbnail_img)}}" alt="{{$master_product->name}}">
                                                <h3>{{$master_product->name}}</h3>
                                            </label></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog w-50" id="modal-dialog45">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="border-bottom1 border-color-111 mt-0 mb-3">
                                          <h3 class="section-title section-title__sm mb-0 pb-0 font-size-18 mt-0">Get A Quote</h3><button type="button" class="close" data-dismiss="modal">×</button>
                                          <div class="deals">
                                             <hr class="mt-2">
                                          </div>
                                       </div>
              ...
              @csrf
				  ...
				  <ul class="list-unstyled d-flex">
                        ...
                        <li class="m-3 mt-0 mb-0">
                            <label for="other">
                                <input type="radio" data-order_button_text="Proceed to PayPal" value="Nickname" name="address_type" class="input-radio" id="other"  >
                                <span>Nickname  </span>
                            </label> 
                        </li>
						<li class="m-3 mt-0 mb-0">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            console.log("I am Ready function");
                ...
                jQuery.ajax({
                    ...
                    success: function(result){
                        ...
                        if(result.status == true){
                            ...
                            //$('#master_product_list').html(result.data.master_product_data);
                        }
                    }
                });
            }
        ...
        $(document).ready(function () {
            $(document).on('click', '.productBuyNow', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        // toastr.info(response.status);
                        (response.nav_cart_view, response.cart_count, response.sum_cart_count);
                        $('#product-box').html(response.product_box_view);
                        setTimeout(function() {
        ...
        //working on dynamic ask quotes modal by AviSingh
        function callAskQuoteModal(service_id){
