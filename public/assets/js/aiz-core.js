...
$('.clist label').click(function () {
	$('.clist label').removeClass("list_active");
...
$("#accountid").on("click", function() {    
	...
	$(".tab1").removeClass('tab_none');
	$(".tab2").addClass('tab_none');
	$(".tab3").addClass('tab_none');
	$(".tab4").addClass('tab_none');
	$(".tab5").addClass('tab_none');
});

$("#bankid").on("click", function() {    
    $(".clist label").removeClass('list_active');
	$(this).addClass('list_active');
	
	$(".tab2").removeClass('tab_none');
	$(".tab1").addClass('tab_none');
	$(".tab3").addClass('tab_none');
	$(".tab4").addClass('tab_none');
	$(".tab5").addClass('tab_none');
});

$("#businessid").on("click", function() {    
    $(".clist label").removeClass('list_active');
	$(this).addClass('list_active');
	
	$(".tab3").removeClass('tab_none');
	$(".tab1").addClass('tab_none');
	$(".tab2").addClass('tab_none');
	$(".tab4").addClass('tab_none');
	$(".tab5").addClass('tab_none');
