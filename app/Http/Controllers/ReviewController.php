...
class ReviewController extends Controller
{
    ...
    public function serviceReviewIndex(Request $request)
    {
        $reviews = ServiceReview::orderBy('created_at', 'desc')->paginate(15);
        return view('backend.services.reviews.index', compact('reviews'));
    }
}
