...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        return view('backend.product.products.index', compact('products','type', 'col_name', 'query', 'sort_search', 'category'));
    }
    ...
    {
        return Excel::download(new ProductExport, 'ebb_products.xlsx');
    }
