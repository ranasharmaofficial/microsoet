...
class BulkOrderController extends Controller
{
    ...
    /**
     * Bulk order request from user
     * data stored in bulk_orders, bulk_order-details, bulk_combined_oeders table
     * function created by @AviSingh
     */
    public function BulkpayOnDelivery(Request $request)
    {
        ...
        // Store Address data in BulkCombinedOrder
        ...
        // Store data in bulk order table
        $order = new BulkOrder;
        ...
        foreach ($carts as $cartItem) {
            ...
            $order_detail->category_id = $cartItem['category_id'];
            $order_detail->product_id = $cartItem['product_id'];
            $order_detail->price = $cartItem['price'];
            $order_detail->total_price = $cartItem['price'] * $cartItem['quantity'];
            $order_detail->tax_percent = $cartItem['tax'];
    ...
    public function BulkpayOnDeliveryRana(Request $request)
    {
        $carts = BulkCart::where('user_id', Auth::user()->id)
            ->get();
